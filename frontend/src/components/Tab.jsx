...
const TabsComponent = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (imageType === "file" && file) {
                formDataToSend.append("image", file); // ✅ Backend expects "image"
            } else if (imageType === "url" && formData.image) {
                formDataToSend.append("imageUrl", formData.image); // ✅ Backend expects "imageUrl"
            }
    
            // ✅ Ensure edit works properly
    ...
    const handleDelete = async (id) => {
        ...
        try {
            ...
            // If the request succeeds, refresh the data
            getData();
        } catch (error) {
